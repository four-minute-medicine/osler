...
export default function Welcome() {
  ...
  return (
    <div className="flex h-screen w-screen bg-white">
      ...
      />
      <IntroSection highlightedWord='HCW' chat='hcw' subtext='E.g. What do I need to to do if a child presents with [symptom]?' unHighlightedWord='Chat' colour='#D1E4D1' discription="Helps healthcare workers (HCWs) find the information they are looking for whilst in the flow of work"/>
    </div>
  );
}